                    ...
                    <ul class="slide-menu">
                        ...
                        <li class="sub-slide">
                            ...
                            <ul class="sub-slide-menu">
                                ...
                                <li><a class="sub-slide-item" href="product-details.html">Product-Details</a>
                                </li>
                        ...
                        <li class="sub-slide">
                            ...
                            <ul class="sub-slide-menu">
                                ...
                                <li><a class="sub-slide-item" href="invoice-details.html">Invoice Details</a>
                                </li>
                                <li><a class="sub-slide-item" href="invoice-create.html">Create Invoice</a></li>
                                <li><a class="sub-slide-item" href="invoice-timelog.html">Time Log Invoice</a>
                                </li>
                        ...
                        <li class="sub-slide">
                            ...
                            <ul class="sub-slide-menu">
                                ...
                                <li><a class="sub-slide-item" href="project-details.html">Project Details</a>
                                </li>
                        ...
                        <li><a href="ticket-details.html" class="slide-item"><span class="side-menu__label">Tickets</span></a>
                        </li>
                        <li class="sub-slide">
                            <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
                    ...
                    <ul class="slide-menu">
                        ...
                        <li class="sub-slide">
                            ...
                            <ul class="sub-slide-menu">
                                ...
                                <li><a class="sub-slide-item" href="forgot-password.html">Forgot Password</a>
                                </li>
                                <li><a class="sub-slide-item" href="lockscreen.html">Lockscreen</a></li>
                                <li><a class="sub-slide-item" href="construction.html">UnderConstruction</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sub-slide">
